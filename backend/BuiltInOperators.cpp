...
Func_Block euqalBlock {"BUILT_IN_EQUAL", 3, &forBuiltInEqual};
...
void builtInOperatorsInit()
{
    ...
    euqalBlock.setParamType(varType_e::BOOL, 0);
    euqalBlock.setParamType(varType_e::INT, 1);
    euqalBlock.setParamType(varType_e::INT, 2);
